  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Column(
          ...
          children: [
            const Row(
              children: [
                KartaMark(size: 44, withBackground: false),
                SizedBox(width: 12),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [Color(0xFFE7FCFA), Color(0xFFEAF4FF)],
                    ),
